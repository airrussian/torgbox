...
Решил сделать ещё один вариант без использования `class`, а на чистых функциях, с помощью которых, путём последовательной трансформации входящей строки привести в формату `ISO 8601`. 

Представленное решение находиться в директории `/source`