...
Решил сделать ещё один вариант без использования `class`, а на чистых функциях, с помощью которых, путём последовательной трансформации, входящую строку привести к формату `ISO 8601`. 

Представленное решение в директории `/source`

Старое решение находиться `/source_old`
